document.write('\
	<header>\
		...
		<button type="button" class="menu"><svg class="icon"><use xlink:href="#icon-hamburger"></use></svg></button>\
		<ul class="menu">\
			<li class="language"><a>ru</a><a href="">en</a></li>\
			<li>\
				<button type="button" class="submenu">О салоне<svg class="icon"><use xlink:href="#icon-arrow"></use></svg></button>\
				<ul class="submenu">\
